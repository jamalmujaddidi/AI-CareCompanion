...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ViewPhoto(title: 'Flutter Demo Home Page'),
    );
  }
}

class ViewPhoto extends StatefulWidget {
  const ViewPhoto({super.key, required this.title});
...
class _ViewPhotoState extends State<ViewPhoto> {
  ...
  Future<void> viewreply() async {
    ...
    try {
      ...
      String url = '$urls/caretaker_view_photo_post/';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        // Here we take the value from the ViewPhoto object that was created by
                          ...
                          SizedBox(width: 150,),
                            IconButton(
                              onPressed: ()async {
                                ...
                                final urls = Uri.parse('$url/caretaker_delete_photo_post/');
                                try {
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: (){
          Navigator.push(context, MaterialPageRoute(builder: (context)=>AddPhoto(title: 'Add Photo',)));
