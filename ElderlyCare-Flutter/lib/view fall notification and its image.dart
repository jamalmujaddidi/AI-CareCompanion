...
void callbackDispatcher1(String message) {
  print("hiii");
  ...
  _showNotificationWithDefaultSound1(flip, message);
  // return Future.value(true);
  // });
}

Future _showNotificationWithDefaultSound1(flip,String message) async {
