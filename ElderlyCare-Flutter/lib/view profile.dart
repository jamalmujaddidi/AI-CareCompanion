...
class ptemp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Caretaker_view_profile(title: 'Home'),
    );
  }
}

class Caretaker_view_profile extends StatefulWidget {
  const Caretaker_view_profile({super.key, required this.title});

  final String title;

  @override
  State<Caretaker_view_profile> createState() => _Caretaker_view_profileState();
}

class _Caretaker_view_profileState extends State<Caretaker_view_profile> {
  _Caretaker_view_profileState() {
    senddata();
  }
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    _profileItem(Icons.home, "Post", post_),
