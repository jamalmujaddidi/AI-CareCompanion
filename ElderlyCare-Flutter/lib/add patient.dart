...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const AddPateintDetails(title: 'Add Pregnent Lady'),
    );
  }
}

class AddPateintDetails extends StatefulWidget {
  const AddPateintDetails({super.key, required this.title});

  final String title;

  @override
  State<AddPateintDetails> createState() => _AddPateintDetailsState();
}

class _AddPateintDetailsState extends State<AddPateintDetails> {
  ...
  TextEditingController hspController = TextEditingController();
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    validator: (value) {
                      if (value!.isEmpty) {
                        return 'Must Enter a valid Name'; // Validation message
                      }
                      return null;
                    },
                  ),
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    validator: (v) {
                      if (v!.isEmpty || !RegExp(r"^[A_Za-z]+").hasMatch(v)) {
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    validator: (v) {
                      if (v!.isEmpty || !RegExp(r"^[A_Za-z]+").hasMatch(v)) {
                        return 'Must Enter valid country';
                      }
                      return null;
                    },
                  ),
  ...
  void senddata() async {
    ...
    final urls = Uri.parse('$url/caretaker_add_patient_post/');
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (status == "ok") {
          ...
          Fluttertoast.showToast(msg: "Patient is added");
          // Navigator.push(
          //     context,
          //     MaterialPageRoute(
          //       builder: (context) => ViewPregnentLady(title: "View Pregnent Lady",),
          //     ));
        } else {
