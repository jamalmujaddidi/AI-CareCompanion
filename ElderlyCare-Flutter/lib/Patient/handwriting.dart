...
//
//     print(base64Image);
//     String typee="malayalam handwriting";
...
//   }
//   Future<void> sendDataPass() async {
//     SharedPreferences sh = await SharedPreferences.getInstance();
...
//
//
//     final Uri urlEndpoint = Uri.parse('$url/handwritingpass/');
//     try {
...
//           // Navigator.push(
//           //   context,
//           //   MaterialPageRoute(builder: (context) => const sent_complaint_new(title: "")),
//           // );
//         } else {
...
//     String? url = sh.getString('url');
//     String? lid = sh.getString('lid').toString();
//     String type="malayalam handwriting";
//     Duration timeTaken = DateTime.now().difference(startTime);
//     completedTime = _formatTime(timeTaken);
//
//
//     final Uri urlEndpoint = Uri.parse('$url/handwritingfail/');
//     try {
//       final response = await http.post(urlEndpoint, body: {
//         'type': type,
//         'lid': lid,
...
class _DrawingPageState extends State<DrawingPagee> {
  ...
  List<String> a = [
    "ക","അ","ആ","ഇ","ഉ","എ","ഏ","ഒ","ക","ഖ","ഗ","ഘ","ങ","ച","ഛ","ജ","ഝ","ഞ",
    "ട","ഠ","ഡ","ഢ","ണ","ത","ഥ","ദ","ധ","ന","പ","ഫ","ബ","ഭ","മ","യ","ര","റ",
    "ല","ള","ഴ","വ","ശ","ഷ","സ","ഹ"
  ];

  List<String> aindex = [
    "3349","3333","3334","3335","3337","3342","3343","3346","3349","3350","3351","3352","3353","3354","3355","3356","3357","3358",
    "3359","3360","3361","3362","3363","3364","3365","3366","3367","3368","3370","3371","3372","3373","3374","3375","3376",
    "3377","3378","3379","3380","3381","3382","3383","3384","3385"
  ];
  ...
  Future<void> _loadOverlayImage() async {
    // Optional: Load an overlay image from assets if needed
  }
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.save),
            onPressed: () {
              startTime = DateTime.now(); // FIX: Start the timer here
              _saveCanvasToString(_indexNumber);
            },
          ),
          IconButton(
      ...
      body: Stack(
        children: [
          Positioned(
            top: 20,
            left: 20,
            child: Text(_randomLetter, style: TextStyle(fontSize: 50)),
          ),
